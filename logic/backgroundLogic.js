...
function initFirstTrees() {
    ...
    for(var i = 0; i<Math.floor(GL.toNumberOfPixels(root.width)*GL.fraction(10, GL.toNumberOfPixels(854)))+1/*Math.floor(GL.toNumberOfPixels(root.width)/(10*game.sizeOfPixel+highLimit))*/; i++) {
        component = Qt.createComponent("../components_dynamic/tree.qml");
